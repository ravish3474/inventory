...
?>
	...
	<style>
		...
		.card-body .select-title .text-danger {
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						...
						<div class="col-sm-3 text-right select-title">
...
if ($op == 'fabrics_detail') {
	...
	if (isset($_GET['fabric_color'])) {
		$fabric_color = base64_decode($_GET['fabric_color']);
	}
...
if ($op == 'fabrics_no_detail') {
	...
	if (isset($_GET['fab_id'])) {
		$fab_id = base64_decode($_GET['fab_id']);
	}
