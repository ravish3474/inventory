			...
			<div class="card-body">
				<div class="profile-header text-white">
					<div class="row">
						...
						<div class="col-md-4 col-sm-12 d-md-flex admin-img-side">
							<center>
								<?php
						...
						<div class="ml-3 col-md-4 col-sm-12 user-details">
							<div class="card">
						...
						<div class="ml-3 col-md-3 col-sm-12 edit-profile-sect">
