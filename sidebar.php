...
switch(intval($_SESSION['employee_position_id'])){
	case 99 : 
		$a_allow = array("profile","materials","draw","forecast","forecast_ordered","po","adjust","adjust_form","rq_list","purchase","setup","report_by_roll"
			,"report_by_date","report_material_used","report_estimate_used","test");
	break;
	case 1 : 
		$a_allow = array("profile","materials","draw","forecast","forecast_ordered","po","adjust","adjust_form","rq_list","purchase","setup","report_by_roll"
			,"report_by_date","report_material_used","report_estimate_used");
	break;
	case 2 :
...
?>
<?php $vp = ""; if( isset($_GET['vp']) ){ $vp = base64_decode($_GET['vp']); } ?>
	<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
        	...
        	?>
			<li class="nav-item <?php if($vp=='profile'){echo 'active';}?>">
			...
			?>
			<li class="nav-item">
				<a class="nav-link" data-toggle="collapse" href="#materials" aria-expanded="<?php if($vp=='fabrics' OR $vp=='accessory'){ echo 'true'; }else{ echo 'false'; } ?>" aria-controls="materials">
					<i class="menu-icon fa fa-cubes"></i>
					<span class="menu-title">Materials</span>
					<i class="menu-arrow"></i>
				</a>
				<div class="collapse <?php if($vp=='fabrics' OR $vp=='accessory' ){echo 'show';}?>" id="materials">
					<ul class="nav flex-column sub-menu">
						<li class="nav-item <?php if($vp=='fabrics' ){echo 'active';}?>">
							<a class="nav-link" href="?vp=<?php echo base64_encode('fabrics').'&op='.base64_encode('fabrics_list');?>">Fabrics</a>
						</li>
						<li class="nav-item <?php if($vp=='accessory'){echo 'active';}?>">
			...
			?>
			<li class="nav-item <?php if($vp=='purchase'){echo 'active';}?>">
			...
			?>
			<li class="nav-item <?php if($vp=='po'){echo 'active';}?>">
			...
			?>
			<li class="nav-item">
				<a class="nav-link" data-toggle="collapse" href="#forecast" aria-expanded="<?php if($vp=='forecast' OR $vp=='forecast_ordered' OR $vp=='forecast_detail' OR $vp=='forecast_report1'){ echo 'true'; }else{ echo 'false'; } ?>" aria-controls="forecast">
					<i class="menu-icon fa fa-linode"></i>
					<span class="menu-title">Forecast</span>
					<i class="menu-arrow"></i>
				</a>
				<div class="collapse <?php if($vp=='forecast' OR $vp=='forecast_detail' OR $vp=='forecast_report1' OR $vp=='forecast_ordered'){echo 'show';}?>" id="forecast">
					<ul class="nav flex-column sub-menu">
						<li class="nav-item <?php if($vp=='forecast_purchase'){echo 'active';}?>">
							<a class="nav-link" href="?vp=<?php echo base64_encode('forecast_purchase');?>">Purchase</a>
						</li>
						<li class="nav-item <?php if($vp=='forecast' OR $vp=='forecast_detail'){echo 'active';}?>">
							<a class="nav-link" href="?vp=<?php echo base64_encode('forecast');?>">List from Orders</a>
						</li>
						<?php if(in_array("forecast_ordered",$a_allow)){ ?>
						<li class="nav-item <?php if( $vp=='forecast_ordered' ){echo 'active';}?>">
							<a class="nav-link" href="?vp=<?php echo base64_encode('forecast_ordered');?>">Ordered to supplier</a>
						</li>
						<?php } ?>
						<li class="nav-item <?php if($vp=='forecast_report1'){echo 'active';}?>">
			...
			?>
			<li class="nav-item <?php if($vp=='rq_list'){echo 'active';}?>">
			...
			?>
			<li class="nav-item <?php if($vp=='draw' ){echo 'active';}?>">
			...
			?>
			<li class="nav-item <?php if($vp=='supplier' OR $vp=='supplier_detail'){echo 'active';}?>">
			...
			?>
			<li class="nav-item">
				<a class="nav-link" data-toggle="collapse" href="#adjust" aria-expanded="<?php if( $vp=='adjust' || $vp=='adjust_form' ){ echo 'true'; }else{ echo 'false'; } ?>" aria-controls="adjust">
					<i class="menu-icon fa fa-balance-scale"></i>
					<span class="menu-title">Adjust</span>
					<i class="menu-arrow"></i>
				</a>
				<div class="collapse <?php if($vp=='adjust' || $vp=='adjust_form'){ echo 'show'; } ?>" id="adjust">
					<ul class="nav flex-column sub-menu">
						<?php 
						if( in_array("adjust",$a_allow) ){ 
						?>
						<li class="nav-item <?php if($vp=='adjust'){ echo 'active'; } ?>">
						...
						?>
						<li class="nav-item <?php if($vp=='adjust_form'){ echo 'active'; } ?>">
			...
			?>
			<li class="nav-item">
				<a class="nav-link" data-toggle="collapse" href="#report" aria-expanded="<?php if( $vp=='report_by_roll' || $vp=='report_by_date' || $vp=='report_material_used' || $vp=='report_estimate_used' ){ echo 'true'; }else{ echo 'false'; } ?>" aria-controls="report">
					<i class="menu-icon fa fa-bar-chart"></i>
					<span class="menu-title">Report</span>
					<i class="menu-arrow"></i>
				</a>
				<div class="collapse <?php if($vp=='report_by_roll' || $vp=='report_by_date' || $vp=='report_material_used' || $vp=='report_estimate_used'){ echo 'show'; } ?>" id="report">
					<ul class="nav flex-column sub-menu">
						<?php
						if(in_array("report_by_roll",$a_allow)){
						?>
						<li class="nav-item <?php if($vp=='report_by_roll'){ echo 'active'; } ?>">
						...
						?>
						<li class="nav-item <?php if($vp=='report_by_date'){ echo 'active'; } ?>">
						...
						?>
						<li class="nav-item <?php if($vp=='report_material_used'){ echo 'active'; } ?>">
						...
						?>
						<li class="nav-item <?php if($vp=='report_estimate_used'){ echo 'active'; } ?>">
			...
			?>
			<li class="nav-item">
				<a class="nav-link" data-toggle="collapse" href="#setup" aria-expanded="<?php if( ($vp=='setup') || ($vp=='employee') || ($vp=='supplier') ){ echo 'true'; }else{ echo 'false'; } ?>" aria-controls="setup">
					<i class="menu-icon fa fa-cogs"></i>
					<span class="menu-title">Setup</span>
					<i class="menu-arrow"></i>
				</a>
				<div class="collapse <?php if( ($vp=='setup') || ($vp=='employee') || ($vp=='supplier') ){ echo 'show'; } ?>" id="setup">
					<ul class="nav flex-column sub-menu">
						<li class="nav-item <?php if($vp=='supplier' OR $vp=='supplier_detail'){echo 'active';}?>">
							<a class="nav-link" href="?vp=<?php echo base64_encode('supplier').'&op='.base64_encode('supplier_list');?>">
								<!-- <i class="menu-icon fa fa-address-book-o"></i> -->
						...
						<li class="nav-item <?php if($vp=='setup' AND $op=='position'){ echo 'active'; }?>">
							<a class="nav-link" href="?vp=<?php echo base64_encode('setup').'&op='.base64_encode('position');?>">Position</a>
						</li>
						<li class="nav-item <?php if($vp=='setup' AND $op=='materials'){ echo 'active'; }?>">
			...
			?>
			<li class="nav-item  <?php if($vp=='test'){echo 'active';}?>">
